...
| 2026-09-22 | **Input fuse: Littelfuse OMNI-BLOK 154 holder (01550900, UL 10 A / 125 V) with a Nano2 453 15 A very-fast fuse (65 V DC, 150 A interrupting), first in the path after BUS IN.** Holder at its rating on the 350 W motor, 70 % on the 60AIM40F; accepted by the operator. Its job is the dead-short backstop behind a failed LTC4364, not overload protection. **No polyfuse**: no SMD part holds 10 A at 60 V, PTCs derate when warm, and the LTC4364 current limit plus the TPS48111 trip already provide resettable protection | new; section 3 |
